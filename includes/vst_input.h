...
#define MASK_CONTROLLER_INPUT_SELECT 0x0001
#define MASK_CONTROLLER_INPUT_L3 0x0002
#define MASK_CONTROLLER_INPUT_R3 0x0004
#define MASK_CONTROLLER_INPUT_START 0x0008
#define MASK_CONTROLLER_INPUT_UP 0x0010
#define MASK_CONTROLLER_INPUT_RIGHT 0x0020
#define MASK_CONTROLLER_INPUT_DOWN 0x0040
#define MASK_CONTROLLER_INPUT_LEFT 0x0080
#define MASK_CONTROLLER_INPUT_L2 0x0100
#define MASK_CONTROLLER_INPUT_R2 0x0200
#define MASK_CONTROLLER_INPUT_L1 0x0400
#define MASK_CONTROLLER_INPUT_R1 0x0800
#define MASK_CONTROLLER_INPUT_TRIANGLE 0x1000
#define MASK_CONTROLLER_INPUT_CIRCLE 0x2000
#define MASK_CONTROLLER_INPUT_CROSS 0x4000
#define MASK_CONTROLLER_INPUT_SQUARE 0x8000
...
ReadControllerInput(u16 *ControllerInput)
{
  ...
  hbyte = (u8)((*ControllerInput & 0xff00) >> 8);
  lbyte = (u8)(*ControllerInput & 0x00ff);

  // Swap the bytes: little endian -> big endian
  *ControllerInput = (u16)(hbyte) | ((u16)(lbyte << 8));
}
